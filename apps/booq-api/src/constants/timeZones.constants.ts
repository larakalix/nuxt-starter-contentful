export const TIME_ZONES_CATALOGUE = [
  {
...
export type ValidTimeZoneCodes =
  (typeof TIME_ZONES_CATALOGUE)[number]['tzCode'];

export const TIME_ZONES = TIME_ZONES_CATALOGUE.map(({ tzCode }) => tzCode);
